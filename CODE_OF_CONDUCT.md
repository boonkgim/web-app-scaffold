...
community leaders responsible for enforcement through GitHub's private reporting:

> **[Report privately](https://github.com/boonkgim/web-app-scaffold/security/advisories/new)**
> — or, in the repository, **Security → Advisories → Report a vulnerability**, which opens
> a thread visible only to the maintainers and you.
