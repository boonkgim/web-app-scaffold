/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: e2a4212c7a2cc5ae7e7e1e4e8b68e6a5)
// Runtime types generated with workerd@1.20260903.1 2026-09-03 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	WORKER_SELF_REFERENCE: Fetcher /* web-app-scaffold-web */;
