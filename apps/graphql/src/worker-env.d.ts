/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false --env-interface=WorkerEnv src/worker-env.d.ts` (hash: ac7445f68f30f0a7cd6daf1badb27d77)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ORIGINS" | "APP_ENV" | "MAIL_FROM" | "MAIL_TRANSPORT" | "MAIL_TEST_RECIPIENTS" | "WEB_ORIGIN" | "STRIPE_MODE">> {}
}
